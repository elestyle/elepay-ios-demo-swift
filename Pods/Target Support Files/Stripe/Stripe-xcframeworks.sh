...
install_xcframework "${PODS_ROOT}/Stripe/InternalFrameworks/static/Stripe3DS2.xcframework" "Stripe3DS2" "library" "ios-x86_64-maccatalyst" "ios-arm64_x86_64-simulator" "ios-arm64"
