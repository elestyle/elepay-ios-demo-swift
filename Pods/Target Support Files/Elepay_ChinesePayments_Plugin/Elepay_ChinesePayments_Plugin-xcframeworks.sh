...
install_xcframework "${PODS_ROOT}/Elepay_ChinesePayments_Plugin/Elepay_ChinesePayments_Plugin.xcframework" "Elepay_ChinesePayments_Plugin" "framework" "ios-i386_x86_64-simulator" "ios-armv7_arm64"
