...
install_xcframework "${PODS_ROOT}/Elepay_ChinesePayments_Plugin/Elepay_ChinesePayments_Plugin.xcframework" "Elepay_ChinesePayments_Plugin" "framework" "ios-arm64_armv7" "ios-i386_x86_64-simulator"
