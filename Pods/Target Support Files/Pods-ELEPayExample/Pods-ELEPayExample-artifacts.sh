...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/ElepaySDK/ElepaySDK.xcframework" "" "true" "ios-armv7_arm64/ElepaySDK.framework" "ios-x86_64_i386-simulator/ElepaySDK.framework"
  install_xcframework "${PODS_ROOT}/Elepay_ChinesePayments_Plugin/Elepay_ChinesePayments_Plugin.xcframework" "" "true" "ios-i386_x86_64-simulator/Elepay_ChinesePayments_Plugin.framework" "ios-armv7_arm64/Elepay_ChinesePayments_Plugin.framework"
fi
