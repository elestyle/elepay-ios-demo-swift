...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/ElepaySDK/ElepaySDK.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Elepay_ChinesePayments_Plugin/Elepay_ChinesePayments_Plugin.framework"
fi
