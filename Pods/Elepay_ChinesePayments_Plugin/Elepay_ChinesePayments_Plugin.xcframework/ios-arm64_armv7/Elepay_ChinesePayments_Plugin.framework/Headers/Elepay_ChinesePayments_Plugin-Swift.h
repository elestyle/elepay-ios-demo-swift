...
#ifndef ELEPAY_CHINESEPAYMENTS_PLUGIN_SWIFT_H
#define ELEPAY_CHINESEPAYMENTS_PLUGIN_SWIFT_H
...
SWIFT_CLASS("_TtC29Elepay_ChinesePayments_Plugin18ElepayAlipayModule")
@interface ElepayAlipayModule : NSObject
